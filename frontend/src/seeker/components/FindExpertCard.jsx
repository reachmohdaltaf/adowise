...
const FindExpertCard = () => {
  return (
    <Link to={'/seeker/dashboard/listing'}><Card className="w-full h-fit gap-2 p-2 bg-primary text-primary-foreground overflow-x-auto">
    <CardHeader className="px-2 mt-2">
     <Link to={'/seeker/dashboard/listing'}><Button className="w-32 sm:w-40 text-xs sm:text-base text-foreground" variant="outline">
