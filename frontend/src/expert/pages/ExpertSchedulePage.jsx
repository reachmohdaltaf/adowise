...
const ExpertSchedulePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 sm:bg-background">
     ...
     <nav className="flex flex-col bg-background hidescroll sticky top-12 z-10 gap-2 mb-2 sm:mb-4 w-full overflow-x-auto px-3 sm:px-2 py-2 border-b sm:border-b-0 shadow-sm sm:shadow-none">
