...
import { CreateService, DeleteServiceById,  fetchAllServices,  GetServiceById, MyServices, UpdateServiceById } from '../controllers/service.controller.js'
import authMiddleware from '../middleware/auth.middleware.js'
const router = express.Router()

router.get('/myservices', authMiddleware, MyServices)
router.get('/getall', authMiddleware, fetchAllServices)
